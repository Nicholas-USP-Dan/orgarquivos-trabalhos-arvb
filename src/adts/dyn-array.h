 ...
 * 
 * @note A alocação de espaço ocorre em potências de 2, então o espaço utilizado não é
 ...
 * 
 * @details Aloca-se um vetor de 1 entrada no começo.
 * 
 * @param f_index Função que gera um index pelo qual ordenação possa ser feita, e assim busca binária
...
/**
 * @brief Retorna o número de elementos não nulos da lista (incluindo elementos removidos).
 * 
 * @param array Referência para o ponteiro do array dinâmico
 * @return [int64_t] Número de elementos não nulos na lista
 */
 ...
 *
 * @details Primeiramente o elemento é inserido no final, depois é realizado um insertion neste elemento
 * para colocá-lo na posição certa
 * 
 * @param el Dado a ser adicionado
 * @param array Referência para o ponteiro do array dinâmico
 *
...
/**
 * @brief Remove um elemento no array pelo índice
 * 
